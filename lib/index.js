...
Una.prototype.enableServerMode = function() {
    var newState = function(room_id, io) {
        ...
        var onControllerInput = function(una_socket, key, payload, cb) {
            var callback = onControllerInputFn[key];
            if (callback) {
                 var result = callback(this, una_socket, payload);
                 cb(result);
            }
        }
        ...
        return {getState: getState,
                ...
                onControllerConnection: this.onControllerConnection,
                onControllerDisconnection: this.onControllerDisconnection};
    };
    ...
    var registerOnControllerConnection = function(fn) {
        this.onControllerConnection = fn;
    }
    var registerOnControllerDisconnection = function(fn) {
        this.onControllerDisconnection = fn;
    }
    ...
    this.server_mode = {newState: newState,
                        ...
                        registerOnControllerConnection: registerOnControllerConnection,
                        registerOnControllerDisconnection: registerOnControllerDisconnection,
                        allStates: allStates};
}
